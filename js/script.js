(function() {
    ...
    (function(BX) {
        ...
        BX.processHTML = function(data, scriptsRunFirst) {
            var matchScript, matchStyle, matchSrc, matchHref, matchType, scripts = [],
                styles = [];
            var textIndexes = [];
        ...
        */
        ...
        BX.getEventButton = function(e) {
            ...
            if (typeof e.which != 'undefined') {
                switch (e.which) {
                    case 1:
                        flags = flags | BX.MSLEFT;
                        break;
                    case 2:
                        flags = flags | BX.MSMIDDLE;
                        break;
                    case 3:
                        flags = flags | BX.MSRIGHT;
                        break;
                }
	 ...
	 */
        ...
        function loadAsyncEmulation(items, callback, doc) {
            ...
            function preLoad(asset) {
                if (asset.state === undefined) {
                    ...
                    loadAsset({ url: asset.url, type: "cache", ext: asset.ext },
                        function() { onPreload(asset); },
                        doc
                    );
                }
        ...
        BX.CHint.prototype.CreateParent = function(element, params) {
            ...
            if (type == "icon") {
                element = BX.create('IMG', {
                    props: {
                        src: params.iconSrc ?
                            params.iconSrc : "/bitrix/js/main/core/images/hint.gif"
                    }
                });
            } else if (type == "link") {
                element = BX.create("A", {
        ...
        function _processTpl(tplNode, cb, bKillTpl) {
            if (tplNode) {
                ...
                var res = {},
                    nodes = BX.findChildren(tplNode, { attribute: 'data-role' }, true);
